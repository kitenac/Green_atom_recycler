...
##### 2. CI: автообработка/проверка/автогенерация
настроен для workflow, запущенных (триггеры: push/pull request) *с авторизацией по ssh-ключам*\ 
- для настройки других типов авторизации, например, PAT - см. шапку .github/workflows/ci.yml

Туду
джобы:
1. автогенерация рисунка со схемой связей в БД при успешном прохождении всего Workflow - push в репохиторий из Artifacts

(Туду х2-xn)
2. автоформатирование кода
3. минимальные проверки линтера
4. юнит тесты
